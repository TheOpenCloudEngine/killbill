...
package org.killbill.billing.invoice.uengine.mybatis;
...
public class InvoiceConnectionFactory {

    private static SqlSessionFactory sqlSessionFactory;

    static {
        try {
            String resource = "org/killbill/billing/invoice/uengine/mybatis-config.xml";
